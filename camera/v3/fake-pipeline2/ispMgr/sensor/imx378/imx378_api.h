 ...
 * Description:
 */
#ifndef __IMX378_API_H__
#define __IMX378_API_H__
...
#if defined(PREVIEW_DEWARP_ENABLE) || defined(PICTURE_DEWARP_ENABLE)
void cmos_get_sensor_gdc_parameter_imx378(struct sensorConfig *cfg, GDCInParam in_params, struct dewarp_params *dewarp_params);
#endif

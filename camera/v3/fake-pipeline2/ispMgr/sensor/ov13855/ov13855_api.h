 ...
 * Description:
 */
#ifndef __OV13855_API_H__
#define __OV13855_API_H__
...
#if defined(PREVIEW_DEWARP_ENABLE) || defined(PICTURE_DEWARP_ENABLE)
void cmos_get_sensor_gdc_parameter_ov13855(struct sensorConfig *cfg, GDCInParam in_params, struct dewarp_params *dewarp_params);
#endif

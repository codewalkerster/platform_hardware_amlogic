 ...
 * Description:
 */
#ifndef __IMX335_API_H__
#define __IMX335_API_H__
...
#if defined(PREVIEW_DEWARP_ENABLE) || defined(PICTURE_DEWARP_ENABLE)
void cmos_get_sensor_gdc_parameter_imx335(struct sensorConfig *cfg, GDCInParam in_params, struct dewarp_params *dewarp_params);
#endif

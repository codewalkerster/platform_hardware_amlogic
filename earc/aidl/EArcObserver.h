...
#define TX_UEVENT_EARC_STATE_UNKNOWN   "EARCTX_ARC_STATE=0"
#define TX_UEVENT_EARC_STATE_ARC       "EARCTX_ARC_STATE=1"
#define TX_UEVENT_EARC_STATE_EARC      "EARCTX_ARC_STATE=2"

#define RX_UEVENT_EARC_STATE_UNKNOWN   "EARCRX_ARC_STATE=0"
#define RX_UEVENT_EARC_STATE_ARC       "EARCRX_ARC_STATE=1"
#define RX_UEVENT_EARC_STATE_EARC      "EARCRX_ARC_STATE=2"
